...
_opencode_rate_limiter() {
    ...
    COMPREPLY=( $(compgen -W "check completions daemon deep generate-config generate-launchd generate-systemd generate-task headers probe quick rotate -h --help --config --json -v --verbose -q --quiet --dry-run --version" -- "${cur}") )
    return 0
}
